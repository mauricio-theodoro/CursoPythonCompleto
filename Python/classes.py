...
Em POO, Classes nada mas são do que modelos dos objetos do mundo real sendo representados
computacionalmente.
...
Classes podem conter:
    ...
    iríamos querer saber se a lâmpada é 110 ou 220 volts, se ela é branca, amarela, vermelha ou outra cor,
    qual é a luminosidade dela e etc.

    - Métodos (funções) -> Representam os comportamentos do objeto. Ou seja, as ações que este objeto
    pode realizar no seu sistema. No caso da lâmpada, por exemplo, um comportamento comum
    que muito provavelmente iriamos querer representar no nosso sistema é o ligar e desligar a mesma.
...
OBS: Quando nomeamos uma classe em Python utilizamos por convenção o nome com inicial
em maiúsculo. Se o nome for composto, utliza-se as iniciais de amabas as palavras em
